...
class ServiceListPreprocessor extends PreprocessorBaseParagraph {
  ...
  public function preprocessParagraph(array &$variables): void {
    $services = [];
    $variables['service_list'] = &$services;
    /** @var Paragraph $paragraph */
    $paragraph = $variables['paragraph'];
    /** @var EntityReferenceFieldItemList $list_field */
    $list_field = $paragraph->get('field_services');
     /** @var Node[] $nodes */
    $nodes = [];
    // Automatically display latest 5 services, unless overridded by manual
    // field.
